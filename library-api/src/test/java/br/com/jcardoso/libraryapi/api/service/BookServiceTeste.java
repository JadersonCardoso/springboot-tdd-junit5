...
public class BookServiceTeste {
    ...
    private Book createValideBook() {
        return Book.builder().isbn("123").author("Fulano").title("As aventuras").build();
    }

    @Test
    @DisplayName("Deve lançar erro de negócio ao tentar salvar um livro com isbn duplicado ")
    public void shoulNotSaveBookIWthDuplicatedISBN() {
        //cenario
        Book book = createValideBook();
    ...
    @Test
    @DisplayName("Deve ocorrer erro ao tentar atualizar um lvro inexistente")
    public void updateInvalidBooTest() {
        Book book = new Book();
    ...
    @Test
    @DisplayName("Deve atualziar um livro")
    public void updateBookTest() {
        ...
        Book updatedBook = createValideBook();
